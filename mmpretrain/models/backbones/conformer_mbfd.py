...
class ConvBlock(BaseModule):
    ...
    def __init__(self,
        ...
        # if cnn_down and stride == 2:
        if False:
            self.conv2 = MBFD(mid_channels, mid_channels, nwa=False)
            print("Using MBFD")
        else:
...
class Conformer_MBFD(BaseBackbone):
    """Conformer backbone.
    ...
    def init_weights(self):
        super(Conformer_MBFD, self).init_weights()
