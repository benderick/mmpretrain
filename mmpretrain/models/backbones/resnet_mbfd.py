...
class ResLayer(nn.Sequential):
    ...
    def __init__(self,
        ...
        if stride != 1 or in_channels != out_channels:
            ...
            conv_stride = stride
            if stride == 2:
                downsample = MBFD(in_channels, out_channels)
            else:
...
class ResNet_MBFD(BaseBackbone):
    """ResNet backbone.
    ...
    def __init__(self,
                 ...
                 drop_path_rate=0.0):
        super(ResNet_MBFD, self).__init__(init_cfg)
    ...
    def _make_stem_layer(self, in_channels, stem_channels):
        self.stem = nn.Sequential(
            FMBFD(in_channels, stem_channels//2),
            MBFD(stem_channels//2, stem_channels),
        )
