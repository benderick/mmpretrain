...
class ConvNeXt_MBFD(BaseBackbone):
    ...
    def __init__(self,
        ...
        stem = nn.Sequential(
            FMBFD(in_channels, self.channels[0]//2, norm_cfg=norm_cfg),
            MBFD(self.channels[0]//2, self.channels[0], norm_cfg=norm_cfg),
        )
        ...
        for i in range(self.num_stages):
            ...
            if i >= 1:
                ...
                #         stride=2),
                # )
                downsample_layer = MBFD(self.channels[i - 1],channels, norm_cfg=norm_cfg)
    ...
    def train(self, mode=True):
        super(ConvNeXt_MBFD, self).train(mode)
        self._freeze_stages()
